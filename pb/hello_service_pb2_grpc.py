...
import pb.hello_service_pb2 as hello__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in hello_service_pb2_grpc.py depends on'
...
class HelloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.multiHello = channel.stream_unary(
...
def add_HelloServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'multiHello': grpc.stream_unary_rpc_method_handler(
                    servicer.multiHello,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'helloService.HelloService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('helloService.HelloService', rpc_method_handlers)
...
class HelloService(object):
    ...
    @staticmethod
    def multiHello(request_iterator,
            target,
            options=(),
